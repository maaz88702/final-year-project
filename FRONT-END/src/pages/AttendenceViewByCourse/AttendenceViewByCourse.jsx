            ...
            <TableBody>
              {filteredStudents.length > 0 ? (
                filteredStudents.map((student, index) => {
                  // Percentage excludes leaves from calculation penalization
                  const activeSessions = student.total - student.leave;
                  const percentage = activeSessions > 0
                    ? ((student.present / activeSessions) * 100).toFixed(1)
                    : "0.0";
                  ...
                  return (
                    <TableRow key={index} hover>
                      ...
                      {/* ABSENT */}
                      <TableCell align="center">
                        <Chip label={student.absent} color="error" size="small" />
                      </TableCell>
                      ...
                      <TableCell align="center">
                        <Typography
                          fontWeight="bold"
                          color={parseFloat(percentage) >= 75 ? "green" : "error"}
                        >
                          {percentage}%
                        </Typography>
                      </TableCell>
